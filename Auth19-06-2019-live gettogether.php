 ...
 function __construct() {
    ...
    public function signup() 
    {
        ...
        if ($this->email_check($email)) {
            ...
            $where = array('email'=>$email,'password'=>md5($password),'full_name'=>$full_name,'address'=>$address,'home_town'=>$home_town,'language'=>$language,'birthday'=>$birthday,'gender'=>$gender,'image'=>$image);
            // $field=array('email');
